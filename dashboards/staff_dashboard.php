    ...
    <div class="card p-4 shadow">
        ...
        <form action="../modules/add_sale.php" method="POST" id="saleForm">
            <div class="row g-3 align-items-end">
                ...
                <!-- ✅ Sleek Typable Discount Section -->
                <div class="col-md-3">
                    <label class="form-label">Discount (%)</label>
                    <input list="discountOptions" id="discountSelect" name="discount" class="form-control"
                           type="number" min="0" max="100" placeholder="Enter or select %" required>
...
document.getElementById("paymentMethod").addEventListener("change", function() {
    document.getElementById("cardTypeGroup").hidden = this.value !== "Card";
});
</script>
...
function computeAndRender() {
    ...
    const discount = Math.min(Math.max(parseFloat(discountSelect.value || '0'), 0), 100);
...
discountSelect.addEventListener('input', computeAndRender);
